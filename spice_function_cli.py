...
class Spice_Parser_Class():
  ...
  def spice_parser(self): 
    ...
    spice_file = self.spice_file.replace("\\", "/")
    ...
    if IS_LINUX:
      ...
      if(result.returncode!=0):
        ...
        return("There was an error during the DC analysis. Check the spice file.")
    ...
    try:
      ...
      return("An error occured while parsing DC analysis currents file.")
    ...
    try:
        ...
        for line in lines:
          ...
          if not found_layers:
            ...
            if line_components[0][0] == 'R':
              ...
              folder = benchmark + "/"
              # print(f"Going to check if {folder} exists")
          ...
          if line[0] == 'R':
            ...
            if line_words[0] not in resistors:
              ...
              return(f"{line_words[0]} has already been parsed.")
      ...
      return("An error occured while parsing Spice file.")
    ...
    return(f"in {elapsed_time:.3f} seconds")
